package example.plugin.handlers;
...
public class HelloWorldHandler {
	...
	@Execute
	public void execute(@Named(IServiceConstants.ACTIVE_SHELL) Shell s, GreetingService service) {
		
		MessageDialog.openInformation(s, "E4 Information Dialog", service.greetingMessage());
